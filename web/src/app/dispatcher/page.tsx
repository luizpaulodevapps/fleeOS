...
type View = "overview" | "permits" | "processes" | "accreditation" | "deaccreditation" | "dispatchers" | "points" | "equipment" | "agenda";
...
export default function DispatcherPage() {
  ...
  const navigation = [
    ...
    { id: "accreditation", label: "Credenciamento", icon: BadgeCheck },
